...
export default function AdminAuditPage() {
    ...
    if (authLoading) return <div className="min-h-screen bg-gray-50"><Navbar /></div>
    ...
    return (
        <div className="bg-gray-50 min-h-screen font-sans selection:bg-[#F0A500] selection:text-white"><Navbar />
